...
export const TimelineComponent = () => {
  ...
  const timelineComponent = [
    ...
    { time: '2022 - 2024', title: 'Tramites En Linea', texto: 'Atención al cliente – Tramites en línea - Municipio En Linea - Registro Civil - Certificados de Agencia Nacional De Tránsito.', key: '6' },
      ...
      {timelineComponent.map((item) => (
        <Timeline.Item key={item.key} className='my-2'>
          ...
          <Timeline.Content className='cursor-default p-2 transition delay-75 rounded-xl hover:bg-gray-700'>
            ...
            <Timeline.Body className='text-white !mb-0'>
              {item.texto} <br />
              {item.cell}
            </Timeline.Body>
          </Timeline.Content>
