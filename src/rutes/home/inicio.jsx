    ...
    <section>
        <div class='grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-10 lg:grid-cols-12'>
            <div class='mr-auto place-self-center lg:col-span-7 animate-fade-right'>
                <h1 class='max-w-2xl mb-4 text-4xl font-extrabold leading-none md:text-5xl xl:text-6xl text-white'>¡Bienvenido a mi portafolio digital!</h1>
                <p class='max-w-2xl mb-6 font-light lg:mb-6 md:text-lg lg:text-xl text-white'>Aquí encontrarás una muestra de mi trabajo y pasión por el desarrollo web.<br/>Explore y descubra cómo puedo agregar valor a su proyecto.</p>
